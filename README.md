...
👯 **I’m looking to collaborate on**: Open source data tools or projects that bridge **Software Engineering** with **Data Infrastructure**.

🤝 **I’m looking for help with**: Advanced cloud architecture patterns in **GCP** and **Terraform** best practices.

🌱 **I’m currently learning**: Transitioning from **SDE** to **Data Engineering**, focusing on **Docker**, **dbt**, and workflow orchestration.

💬 **Ask me about**: **Python**, **SQL**, **UX Engineering**, or how I use **visual thinking** to solve CS problems.

⚡ **Fun fact**: I love explaining technical concepts through **life examples** and I am a proud cat mom to **Bear** 🐱.
...
---
[![](https://visitcount.itsvg.in/api?id=ivylu888&icon=1&color=0)](https://visitcount.itsvg.in)
